 ...
 */
package com.g7.framework.generator.reactive;

import com.g7.framework.generator.reactive.allocator.BitsAllocator;
import com.g7.framework.generator.reactive.exception.UidGenerateException;
import com.g7.framework.generator.reactive.utils.DateUtils;
import com.g7.framework.generator.reactive.utils.UidContext;
import com.g7.framework.generator.reactive.worker.WorkerIdAssigner;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (workerId > bitsAllocator.getMaxWorkerId()) {
            throw new UidGenerateException("Worker id " + workerId + " exceeds the max " +
                    bitsAllocator.getMaxWorkerId());
        }

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("Initialized bits(1, {}, {}, {}) for workerID:{}", timeBits, workerBits, seqBits, workerId);
        }
    }
    ...
    public UidContext parseUid(long uid) {
        ...
        // format as UidContext
        UidContext context = new UidContext();
        context.setUid(uid);
        context.setTimestamp(thatTimeStr);
